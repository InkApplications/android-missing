 ...
 * @param activityClass The activity to be started.
 */
fun Activity.startActivity(activityClass: KClass<out Activity>) = startActivity(Intent(this, activityClass.java))
 ...
 */
fun Activity.startActivityForResult(activityClass: KClass<out Activity>, requestCode: Int) = startActivityForResult(Intent(this, activityClass.java), requestCode)
 ...
 */
fun Activity.finishResult(resultCode: Int) { setResult(resultCode); finish() }
